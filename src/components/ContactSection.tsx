      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="p-5 rounded-2xl bg-[#0c0e14] border border-white/[0.07] flex items-center justify-between">
            ...
            <div className="p-5 rounded-2xl bg-[#0c0e14] border border-white/[0.07] flex items-center justify-between">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-2 rounded-lg bg-[#09C8FF] text-[#041a24] font-bold hover:bg-[#4cd7ff] transition-colors"
            ...
            <div className="p-5 rounded-2xl bg-[#0c0e14] border border-white/[0.07] space-y-3">
              <div className="flex items-center gap-3">
          ...
          <div className="lg:col-span-7 p-6 sm:p-8 rounded-2xl bg-[#0c0e14] border border-white/[0.08] shadow-xl">
            {formSubmitted && lastSentData ? (
              <div className="py-8 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  <a
                    ...
                    className="flex-1 py-3 px-4 rounded-xl bg-[#09C8FF] hover:bg-[#4cd7ff] text-[#041a24] font-bold text-xs flex items-center justify-center gap-2 transition-all shadow-md shadow-[#09C8FF]/20 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="py-3 px-4 rounded-xl bg-zinc-800 hover:bg-zinc-700 text-zinc-200 hover:text-white text-xs font-semibold flex items-center justify-center gap-2 border border-white/10 transition-colors cursor-pointer"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {isSubjectCustomized && (
                      <button
                        ...
                        className="text-[10px] text-zinc-500 hover:text-[#09C8FF] transition-colors"
                      >
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-[#09C8FF] hover:bg-[#4cd7ff] text-[#041a24] font-bold text-xs flex items-center justify-center gap-2 transition-all shadow-md shadow-[#09C8FF]/20 active:scale-[0.99] disabled:opacity-75 cursor-pointer"
                >
                  {isSubmitting ? (
                    <>
