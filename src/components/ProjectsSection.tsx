    ...
    <section id="projetos" className="py-20 border-t border-white/[0.06] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          ...
          <div className="flex items-center gap-3 self-start md:self-auto">
            ...
            <button
              ...
              disabled={loading}
              className="p-2 rounded-xl bg-zinc-900/90 hover:bg-zinc-800 border border-white/[0.08] text-zinc-400 hover:text-[#09C8FF] transition-colors cursor-pointer"
        ...
        {loading ? (
          ...
          <div className="text-center py-16 px-4 rounded-2xl bg-[#0c0e14] border border-white/[0.05]">
